...
function ozh_ta_get_tweets( $echo = false ) {
	...
	// No tweets found
		...
		$ozh_ta['twitter_stats']['link_count']     = $wpdb->get_var( "SELECT COUNT(ID) FROM `$wpdb->posts` WHERE `post_type` = 'tweet' AND `post_status` = 'publish' AND `post_content` LIKE '%class=\"link%'" );
