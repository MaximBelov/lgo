...
<div class="social-share">
    <ul>
        <li id="twitter-social-share" data-twitter-user="<?php echo $twitter; ?>"><a target="_blank" title="Tweet" href="http://twitter.com/home?status=<?php echo get_the_title();?> @<?php echo $twitter; ?> <?php echo get_the_permalink();?>" ><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
