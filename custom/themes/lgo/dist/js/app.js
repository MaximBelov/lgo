...
(function(factory) {
    ...
    Accordion.prototype.initAttributes = function() {
        ...
        this.$wrapper.each($.proxy(function(index, el) {
            ...
            if (!$wrapper.attr('id')) {
                $wrapper.attr('id', this.options.accordionPrefixId + '-' + randomNumber);
            }
        }, this));
...
jQuery(document).ready(function($) {
    ...
    $('#bookmark-social-share').click(function(e) {
      ...
      if ('addToHomescreen' in window && addToHomescreen.isCompatible) {
        ...
        alert('Close this dialogue box by clicking "OK", then press ' + (/Mac/i.test(navigator.userAgent) ? 'Cmd' : 'Ctrl') + '+D to bookmark this page.');
      }
